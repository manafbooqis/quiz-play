  ...
  return (
    <>
      ...
      <div className="relative min-h-screen flex items-center justify-center px-6 z-30">
        <div className="relative w-full max-w-lg bg-slate-800/70 backdrop-blur-xl rounded-3xl shadow-4xl border-2 border-cyan-400/50 p-8 overflow-hidden">
        ...
        <h1 className="game-font text-4xl md:text-5xl text-center text-white mb-4 bg-gradient-to-r from-cyan-400/20 via-transparent to-cyan-400/10 bg-clip-text text-transparent bg-clip-text drop-shadow-lg">
          <span className="relative z-10">Instructor Login</span>
        </h1>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
              ...
              <div className="mt-6 pt-6 border-t border-slate-600">
                <button
                  ...
                  disabled={loading}
                  className="w-full border-2 border-slate-600/50 bg-transparent text-slate-300 font-medium py-3 rounded-xl hover:bg-slate-700/50 hover:border-slate-500/50 transition-all duration-300 backdrop-blur-sm"
                >
                  Continue as Guest
                </button>
